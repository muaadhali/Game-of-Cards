Feature: Card Game
    ...
    Scenario: A1_scenario
        ...
        And player 2 drawing resolves
        And player 2 has 16 cards
        And player 2 trims card 1
        And player 2 trims card 1
        And player 2 trims card 1
        And player 2 trims card 1
        And player 2 trimming resolves
    ...
    Scenario: 1winner_game_with_events
        ...
        And player finishes making choices
        And player 3 accepts
        And player 3 adds a "Excalibur" card with value 30
        And player finishes making choices
        And player 4 accepts
        And player 4 adds a "Horse" card with value 10
        And player 4 adds a "Battle-Axe" card with value 15
        ...
        And player 4 has 4 shields
        And player 1 has 8 cards
        And player 1 drawing resolves
        And player 1 has 16 cards
        And player 1 trims card 13
        And player 1 trims card 13
        And player 1 trims card 13
        And player 1 trims card 13
        And player 1 trimming resolves
        And player 1 has 12 cards
#        And player 1 drawing and trimming resolves and ends with 12 cards
        And player 2 draws a "Plague" event card
        And the event resolves
...
#        And player 1 drawing and trimming resolves and ends with 12 cards
        And player 1 trimming resolves
        And player 1 has 12 cards
        And player 4 draws a "Queen's Favor" event card
        And the event resolves
        And player 4 has 14 cards
        And player 4 trims card 13
        And player 4 trims card 13
#        And player 4 drawing and trimming resolves and ends with 12 cards
        And player 4 trimming resolves
